...
\header{Chong }{Yun Long}{Fullstack Software Engineer}{\href{mailto:chong.yunlong+jobs@gmail.com}{chong.yunlong+jobs@gmail.com} \textbar \href{https://sg.linkedin.com/in/chongyl}{linkedin.com/in/chongyl}}
% \smallheader{test}{2}
...
{
\role{\emph{Vice President -- Investment Insights Group}}{May 2023 \to now}
\begin{itemize}
\item Developed internal systems to support Private Equity investments and analysis
\item Implemented chat agents using vector stores and OpenAI APIs to enhance the efficiency of investment managers and extract insights from internal datasets.
\item Reduced build times for a large JavaScript codebase by up to fourfold, from 20 minutes to 5 minutes.
\item Optimized performance across various systems, achieving a latency reduction of up to 70\% for backend APIs while ensuring better reliability through the offloading analytics to the browser using DuckDB-Wasm.
\item Identified issues with network routing to overseas offices and optimized network bandwidth by implementing various compression techniques, resulting in a bandwidth reduction of over 30\%.
\end{itemize}
\techstack{FastAPI}{Python}{React}{TypeScript}{Kubernetes}
}
...
\item Migrated \emph{Indeed Certifications}, an incubator product, from legacy Django templates to a modern stack on React and Spring Boot.
...
% \end{itemize}
% \techstack{Windows Kernel}{x86}{QEMU internals}{IDA Pro}{Python}{C}
% }
